...
import numpy as np
from django.core.exceptions import (NON_FIELD_ERRORS, EmptyResultSet,
...
from apps.infra.managers import (EquipamentoManager,
                                 StorageAreaGrupoTrabalhoManager,
                                 StorageAreaManager)

LINHAS = ["-","AA","AB","AC","AD","AE","AF","AG","AH","AI","AJ","AK","AL","AM","AN","AO","AP","AQ",
...
class Rede(models.Model):
    ...
    prioridade_montagem =  models.IntegerField("prioridade de montagem", null=True, help_text='A prioridade de montagem é utilizada quando o Portal cria o Automount Locations e o equipamento possui mais de uma rede com NFS de discos, o MAIOR VALOR tem a prioridade')
...
class HostnameIP(models.Model):
    ...
    tipo = models.ForeignKey(Rede, on_delete=models.PROTECT, blank=True, null=True)
    ip = models.CharField("IP", max_length=255, unique=True, null=True)
...
class Servidor(Equipamento):
    ...
    vinculado = models.ForeignKey(Equipamento, verbose_name="Equipamento Vinculado", blank=True, null=True, related_name="servidor_vinculo", on_delete=models.PROTECT)
    hostname_ip = models.ManyToManyField(HostnameIP, through="ServidorHostnameIP")
...
class ServidorHostnameIP(models.Model):
    ...
    hostnameip = models.ForeignKey(HostnameIP, verbose_name="Hostname", on_delete=models.PROTECT)
...
class StorageAreaGrupoTrabalho(models.Model):
    ...
    storage_area = models.ForeignKey(StorageArea, verbose_name="Area", on_delete=models.PROTECT)
    grupo = models.ForeignKey(GrupoTrabalho, verbose_name="Grupo", on_delete=models.PROTECT)
...
class EquipamentoParte(Equipamento):
    configuracao = models.TextField("Configuração", blank=True, null=True)
    vinculado = models.ForeignKey(Equipamento, verbose_name="Equipamento Vinculado", blank=True, null=True, related_name="equipamentoparte_vinculo", on_delete=models.PROTECT)
    nome = None
    nome_inline = None
...
class Ocorrencia(models.Model):
    ...
    equipamento = models.ForeignKey(Equipamento, verbose_name="Equipamento", on_delete=models.CASCADE, blank=True, null=True,)
